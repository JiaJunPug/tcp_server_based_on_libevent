...
int
DigestEncryptionAlgorithmIdentifier_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
DigestEncryptionAlgorithmIdentifier_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
DigestEncryptionAlgorithmIdentifier_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	DigestEncryptionAlgorithmIdentifier_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
DigestEncryptionAlgorithmIdentifier_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
DigestEncryptionAlgorithmIdentifier_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DigestEncryptionAlgorithmIdentifier_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
DigestEncryptionAlgorithmIdentifier_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DigestEncryptionAlgorithmIdentifier_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_DigestEncryptionAlgorithmIdentifier = {
	...
	"DigestEncryptionAlgorithmIdentifier",
	DigestEncryptionAlgorithmIdentifier_free,
	DigestEncryptionAlgorithmIdentifier_print,
	DigestEncryptionAlgorithmIdentifier_constraint,
	DigestEncryptionAlgorithmIdentifier_decode_ber,
	DigestEncryptionAlgorithmIdentifier_encode_der,
	DigestEncryptionAlgorithmIdentifier_decode_xer,
	DigestEncryptionAlgorithmIdentifier_encode_xer,
